...
describe('Merging Internet calendars', () => {
  ...
  describe('Getting correctly the 2 calendars', () => {
    test.skip('PreBenjamin calendar has 24 matches', async () => {
      ...
      expect(preBenjaminMatches.length).toBe(24)
    })

    test.skip('Benjamin calendar has 30 matches', async () => {
  ...
  describe('Checking the length of the season', () => {
    test.skip('Merging 2 simple calendars groups correctly into 2 weeks', async () => {
